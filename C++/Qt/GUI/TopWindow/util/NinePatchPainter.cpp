...
/*-----------------------------------------------------------------------------|
 |                              NinePatchPainter                               |
 |----------------------------------------------------------------------------*/
NinePatchPainterNew::NinePatchPainterNew(const QPixmap &background,
	int left, int top, int right, int bottom,
	bool horizontalStretch, bool verticalStretch)
	: d(new NinePatchPainterPrivate(background, left, top, right, bottom, horizontalStretch, verticalStretch)) {
}

NinePatchPainterNew::~NinePatchPainterNew() {
	delete d;
}


void NinePatchPainterNew::paint(QPainter *painter, const QRect &rect) const {
