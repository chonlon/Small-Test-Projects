...
extern PROTOBUF_INTERNAL_EXPORT_1_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_1_2eproto;
namespace tutorial {
...
static void InitDefaultsscc_info_Person_1_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Person_1_2eproto}, {
      &scc_info_Person_PhoneNumber_1_2eproto.base,}};

static void InitDefaultsscc_info_Person_PhoneNumber_1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_PhoneNumber_1_2eproto}, {}};

static void InitDefaultsscc_info_PersonResponse_1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PersonResponse_1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PersonResponse_1_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_1_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_1_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_1_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_1_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  1,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::tutorial::PersonResponse, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::tutorial::PersonResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tutorial::PersonResponse, status_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::tutorial::Person_PhoneNumber)},
  { 9, 18, sizeof(::tutorial::Person)},
  { 22, 28, sizeof(::tutorial::PersonResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tutorial::_PersonResponse_default_instance_),
};

const char descriptor_table_protodef_1_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\0071.proto\022\010tutorial\"\333\001\n\006Person\022\014\n\004name\030\001"
  ...
  "\002\" \n\016PersonResponse\022\016\n\006status\030\001 \002(\t2E\n\rP"
  "ersonService\0224\n\006upload\022\020.tutorial.Person"
  "\032\030.tutorial.PersonResponse"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_1_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_1_2eproto_sccs[3] = {
  &scc_info_Person_1_2eproto.base,
  &scc_info_Person_PhoneNumber_1_2eproto.base,
  &scc_info_PersonResponse_1_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_1_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_1_2eproto = {
  false, false, descriptor_table_protodef_1_2eproto, "1.proto", 346,
  &descriptor_table_1_2eproto_once, descriptor_table_1_2eproto_sccs, descriptor_table_1_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_1_2eproto::offsets,
  file_level_metadata_1_2eproto, 3, file_level_enum_descriptors_1_2eproto, file_level_service_descriptors_1_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_1_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_1_2eproto)), true);
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_1_2eproto);
  return file_level_enum_descriptors_1_2eproto[0];
}
...
void Person_PhoneNumber::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_PhoneNumber_1_2eproto.base);
  number_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_ = 1;
}
...
void Person::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_1_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  email_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  id_ = 0;
}
...
class PersonResponse::_Internal {
 public:
  using HasBits = decltype(std::declval<PersonResponse>()._has_bits_);
...
PersonResponse::PersonResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:tutorial.PersonResponse)
}
...
void PersonResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PersonResponse_1_2eproto.base);
  status_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tutorial.PersonResponse.status");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* PersonResponse::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "tutorial.PersonResponse.status");
    target = stream->WriteStringMaybeAliased(
...
template<> PROTOBUF_NOINLINE ::tutorial::PersonResponse* Arena::CreateMaybeMessage< ::tutorial::PersonResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tutorial::PersonResponse >(arena);
}
