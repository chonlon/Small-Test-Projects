...
int main() {
    ...
    // => "The only answer is 42"
    // same as
    std::cout << format("The only {0[what]} is {0[value]}", m2) << "\n";
    // => "The only answer is 42"
    // And if you just want the string,
    std::string result2 = svformat("The only {what} is {value}", m2);
    // => "The only answer is 42"
    std::string result3 = sformat("The only {0[what]} is {0[value]}", m2);
    // => "The only answer is 42"
    ...
    std::cout << format("{2:+^*0}", 9, "unused", 456)
              << "\n";  // => "+++456+++"
