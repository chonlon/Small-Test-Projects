...
plugins=(wd autojump zsh-syntax-highlighting zsh-autosuggestions sudo extract zsh-proxy)
...
alias grep="rg"
alias find="fd"
alias clion="clion 1>>/dev/null 2>>/dev/null &"
