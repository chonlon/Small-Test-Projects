    ...
    , mrtu_(mrtu)
{
    ...
    connect(this_thread_, &QThread::finished, this, &QObject::deleteLater);
    this_thread_->start();
}
...
CModbus::~CModbus()
{
    ...
    if (this_thread_) {
        disconnect(this_thread_, &QThread::finished, this, &QObject::deleteLater);
        this_thread_->quit();
